package view.services.cadastro;
...
public class Cadastro extends javax.swing.JDialog {
    ...
    private void cadastrarButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cadastrarButtonActionPerformed
        ...
        supplier.setContato(jTextField2.getText());
        supplier.setId((int) Double.parseDouble(jTextField3.getText()));
        supplier.setPassword(jTextField5.getText());
        dao.insert(supplier);
        this.dispose();

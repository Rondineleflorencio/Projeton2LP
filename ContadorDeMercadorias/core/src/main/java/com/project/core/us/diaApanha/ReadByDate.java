...
import com.project.core.ports.driver.diaApanhaDriver.ReadDiaByDate;

public record ReadByDate() implements ReadDiaByDate {
    
    @Override
    public List<DiaApanha> apply(int dat, String sql, String table) {
